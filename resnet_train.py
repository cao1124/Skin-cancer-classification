...
def prepare_train(data_dir):
    ...
    train_data = DataLoader(train_dataset, batch_size=52,
                            shuffle=True, num_workers=8)
    valid_data = DataLoader(val_dataset, batch_size=52,
    ...
    resnet.classifier = nn.Linear(in_features=2208, out_features=22, bias=True)
